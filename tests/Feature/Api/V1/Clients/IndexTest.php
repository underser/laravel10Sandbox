...
class IndexTest extends ApiTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->endpoint = route('api.clients.index', [$this->client1]);
    ...
    {
        User::factory(4)->create()->each(fn (User $user) => $user->assignRole(UserRoles::CLIENT->value));
        User::factory()->create()->assignRole(UserRoles::USER->value);
