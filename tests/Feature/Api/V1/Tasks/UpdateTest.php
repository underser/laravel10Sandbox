...
class UpdateTest extends ApiTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->endpoint = route('api.tasks.update', [$this->task]);
    }

    public function test_only_authorized_users_can_update_task(): void
    {
        $this->putJson($this->endpoint, (array)$this->payload)
            ->assertUnauthorized();
    }

    public function test_users_with_user_role_can_update_task(): void
    {
    ...
    public function test_users_with_client_role_can_update_task(): void
    {
    ...
    public function test_users_with_project_manager_role_can_update_task(): void
    {
    ...
    public function test_task_update_endpoint(): void
    {
        $this->putJson($this->endpoint, (array)$this->payload, $this->adminAuthHeader)
            ->assertJson(fn(AssertableJson $json) =>
                $json->has('data', fn(AssertableJson $json) =>
