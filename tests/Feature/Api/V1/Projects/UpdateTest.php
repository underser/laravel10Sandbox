...
class UpdateTest extends ApiTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->project = Project::factory()->create([
            ...
            'user_id' => User::factory()->create()->assignRole(UserRoles::USER->value),
        ]);
        $this->endpoint = route('api.projects.update', [$this->project]);
    ...
    public function test_only_authorized_users_can_update_project(): void
    {
        $this->putJson($this->endpoint, (array)$this->payload)
            ->assertUnauthorized();
    }

    public function test_users_with_user_role_cannot_update_project(): void
    {
        ...
        $this->putJson($this->endpoint, (array)$this->payload, $this->getAuthorizationHeader($userToken))
            ->assertForbidden()
    ...
    public function test_users_with_client_role_can_update_project(): void
    {
        ...
        $this->putJson($this->endpoint, (array)$this->payload, $this->getAuthorizationHeader($clientToken))
            ->assertOk()
            ->assertJson(fn(AssertableJson $json) =>
                $json->has('data', fn(AssertableJson $json) =>
                    $json->where('id', $this->project->id)
    ...
    public function test_users_with_project_manager_role_can_update_project(): void
    {
        ...
        $this->putJson($this->endpoint, (array)$this->payload, $this->getAuthorizationHeader($projectManagerToken))
            ->assertOk()
            ->assertJson(fn(AssertableJson $json) =>
                $json->has('data', fn(AssertableJson $json) =>
                    $json->where('id', $this->project->id)
    ...
    public function test_project_update_validation(): void
    {
        $this->payload->name = '';
        ...
        $this->putJson($this->endpoint, (array)$this->payload, $this->adminAuthHeader)
            ->assertJson(fn(AssertableJson $json) =>
    ...
    public function test_project_update_endpoint(): void
    {
        $this->putJson($this->endpoint, (array)$this->payload, $this->adminAuthHeader)
            ->assertJson(fn(AssertableJson $json) =>
                $json->has('data', fn(AssertableJson $json) =>
