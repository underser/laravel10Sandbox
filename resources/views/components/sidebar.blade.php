            ...
            <li class="filament-sidebar-group">
                <ul class="text-sm space-y-1 -mx-3 mt-2">
                    ...
                    <li class="filament-sidebar-item overflow-hidden filament-sidebar-item-active">
                        <x-crm.nav-link href="{{ route('customers.index') }}" :active="request()->routeIs('customers*')">
                            <svg class="h-5 w-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                    ...
                    <li class="filament-sidebar-item overflow-hidden filament-sidebar-item-active">
                        <x-crm.nav-link href="{{ route('clients.index') }}" :active="request()->routeIs('clients*')">
                            <svg class="h-5 w-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                    ...
                    <li class="filament-sidebar-item overflow-hidden filament-sidebar-item-active">
                        <x-crm.nav-link href="{{ route('projects.index') }}" :active="request()->routeIs('projects*')">
                            <svg class="h-5 w-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                    ...
                    <li class="filament-sidebar-item overflow-hidden filament-sidebar-item-active">
                        <x-crm.nav-link href="{{ route('tasks.index') }}" :active="request()->routeIs('tasks*')">
                            <svg class="h-5 w-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
